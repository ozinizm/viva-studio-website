                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-white p-4 rounded-xl border">
                                {settings.logo_url && <img src={getMediaUrl(settings.logo_url)} onError={handleImageError} alt="Logo" className="h-12 object-contain bg-sage/5 p-1 rounded border" />}
                        ...
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-white p-4 rounded-xl border">
                                {settings.favicon_url && <img src={getMediaUrl(settings.favicon_url)} onError={handleImageError} alt="Favicon" className="w-8 h-8 object-contain rounded border" />}
                                <div className="flex-1 space-y-2 w-full">
                ...
                {activeTab === 'hero' && (
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-white p-4 rounded-xl border">
                                {settings.hero_image_url && <img src={getMediaUrl(settings.hero_image_url)} onError={handleImageError} alt="Hero" className="h-12 object-contain rounded border" />}
                                <div className="flex-1 space-y-2 w-full">
                        ...
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-white p-4 rounded-xl border">
                                {settings.hero_mobile_poster_url && <img src={getMediaUrl(settings.hero_mobile_poster_url)} onError={handleImageError} alt="Poster" className="h-12 object-contain rounded border" />}
                                <div className="flex-1 space-y-2 w-full">
                ...
                {activeTab === 'seo' && (
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-white p-4 rounded-xl border">
                                {settings.og_image_url && <img src={getMediaUrl(settings.og_image_url)} onError={handleImageError} alt="OG" className="h-12 object-contain rounded border" />}
                                <div className="flex-1 space-y-2 w-full">
